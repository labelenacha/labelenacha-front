...
const Animation = ({className = "w-full lg:w-1/2 h-[35vh] md:h-[55vh] lg:h-[65vh] z-0", style, fileName, desiredSize, rotateX, rotateY, posX, posY}) => {
  ...
  useEffect(() => {
    ...
    const hemiLight = new THREE.HemisphereLight(0xffffff, 0x444444, 2.6);
    ...
    loader.load(fileName, (gltf) => {
        ...
        model.position.y += ((Math.abs(bbox.min.y)+posX) * scale);
        model.position.x += posY;
